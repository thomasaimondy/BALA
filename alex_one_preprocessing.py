...
if __name__ == "__main__":
    ...
    if mode == 0:
        ...
        frames_src_path = '/home/bibo/Data/video_to_sequence/data/test_one_video/task1'
        frames_feat_path = '/home/bibo/Data/video_to_sequence/data/test_one_feature/task2'
        sys.exit(get_continuous_features_from_frames(frames_src_path, frames_feat_path))
    else:
        print 'Mode Error!'