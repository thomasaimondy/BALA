...
deploy = '/home/bibo/Data/video_to_sequence/caffe/models/bvlc_reference_caffenet/deploy.prototxt'
model = '/home/bibo/Data/video_to_sequence/caffe/models/bvlc_reference_caffenet/bvlc_reference_caffenet.caffemodel'
mean = '/home/bibo/Data/video_to_sequence/caffe/python/caffe/imagenet/ilsvrc_2012_mean.npy'
...
class CNN(object):
    ...
    def get_features(self, image_list, layers='fc7', layer_sizes=[4096]):
        ...
        for start, end in zip(range(0, iter_until, self.batch_size), 
            ...
            # t_end = time.clock()
            # print 'time(net.forward_all) =', t_end - t_start
